    ...
    <div class="content animated fadeIn">
        <div class="block block-rounded">
            <div class="block-header block-header-default">
                <h3 class="block-title"> 首页模块设置 </h3>
            ...
            <div class="block-content">
                <form onsubmit="return saveSettings(this)" method="post" name="edit-form" role="form">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="mb-4">
                                <label class="form-label" for="Index_Hitokoto"><b>自定义首页</b></label>
                                <div class="space-x-2">
                                    <div class="form-check form-check-inline">
                                        <label class="form-check-label">
                                            <input class="form-check-input" type="radio" name="Index_Hitokoto" value="0" <?=conf_index('Index_Hitokoto')==0?"checked":""?>>显示自定义公告
                                        </label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <label class="form-check-label">
                                            <input class="form-check-input" type="radio" name="Index_Hitokoto" value="1" <?=conf_index('Index_Hitokoto')==1?"checked":""?>>显示一言
                                        </label>
                                    </div>
                                </div>
                            </div>
                            <?php if (conf_index('Index_Hitokoto') == 0) {?>
                            <div class="mb-4">
                                <label class="form-label" for="Index_text"><b>自定义公告</b></label>
                                <input type="text" class="form-control form-control-lg" name="Index_text" value="<?php echo conf_index('Index_text');?>" placeholder="请输入自定义公告">
                            </div>
                            <?php }?>
                            <div class="mb-4">
